      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <span style={{
            ...
            color: "#8B5CF6", fontSize: "12px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em",
          }}>
          ...
          }}>The Developer Behind the Code</h2>
        </motion.div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "48px", alignItems: "start" }}>
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
              {stats.map((stat, i) => (
                ...
                >
                  <div style={{ fontFamily: '"Space Grotesk", sans-serif', fontWeight: 700, fontSize: "28px", color: stat.color, marginBottom: "4px" }}>{stat.value}</div>
          ...
          >
            ...
            {/* Education Timeline */}
            <div>
              <h4 style={{ fontFamily: '"Space Grotesk", sans-serif', fontWeight: 600, fontSize: "16px", marginBottom: "20px", color: "rgba(255,255,255,0.9)" }}>Education</h4>
                  ...
                  >
                    ...
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "4px" }}>
                        <h5 style={{ fontWeight: 600, fontSize: "14px" }}>{edu.title}</h5>
                        <span style={{ color: edu.color, fontSize: "11px", fontWeight: 600 }}>{edu.period}</span>
                      </div>
                      <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "12px", marginBottom: "6px" }}>{edu.school}</p>
                      <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "13px", lineHeight: 1.5 }}>{edu.desc}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
